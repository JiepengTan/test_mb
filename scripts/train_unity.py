        ...
        for epoch in range(st, args.epochs):
            ...
            if hasattr(args, "dt_file_h36m") and epoch < args.warmup_h36m:
                ...
                for k, v in test_losses_dict.items():
                    train_writer.add_scalar('test_loss_h36m/'+k, v.avg, epoch + 1)
                train_writer.add_scalar('test_loss_h36m', test_loss, epoch + 1)
                train_writer.add_scalar('test_mpjpe_h36m', test_mpjpe, epoch + 1)
                train_writer.add_scalar('test_pa_mpjpe_h36m', test_pa_mpjpe, epoch + 1)
                train_writer.add_scalar('test_mpve_h36m', test_mpve, epoch + 1)
