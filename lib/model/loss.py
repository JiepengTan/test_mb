...
def set_unity_data_format(joint_count = 17):
    global limbs_id  # Declare limbs_id as global to update it
    global angle_id  # Declare limbs_id as global to update it
    # child , parent
    if(joint_count == 52):
        limbs_id = [
